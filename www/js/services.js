...
(function() {
  angular.module("hcMobile.services", []).factory('SessionFactory', function($window) {
    var _sessionFactory;
    _sessionFactory = {};
    ...
    return $resource('http://homeclub.us/api/sensor-hubs/:id', {
      id: '@_id'
    }, {
      update: {
        method: 'PUT'
    ...
    return $resource('http://homeclub.us/api/customer-accounts/:id', {
      id: '@_id'
    }, {
      update: {
        method: 'PUT'
